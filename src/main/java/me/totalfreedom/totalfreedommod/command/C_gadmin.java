...
public class C_gadmin extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        switch (mode)
        {
            case KICK:
            {
                ...
                target.kickPlayer("Get kicked by Administrator bitch");
            ...
            case NAMEBAN:
            {
                ...
                target.kickPlayer("Now your Username banned by Administrator what the fuck did u do this time?!?!");
            ...
            case IPBAN:
            {
                ...
                target.kickPlayer("Now your IP address banned by Administrator oh my fucking god HIDE YOUR ABUSIVE WAYS!");
            ...
            case BAN:
            {
                ...
                target.kickPlayer("You done fucked up your IP and username was banned by Administrator GG fam...");
            ...
            case OP:
            {
                ...
                target.setOp(true);
                target.sendMessage(CmdMessages.YOU_ARE_OP);
            ...
            case DEOP:
            {
                ...
                target.setOp(false);
                target.sendMessage(CmdMessages.YOU_ARE_NOT_OP);
