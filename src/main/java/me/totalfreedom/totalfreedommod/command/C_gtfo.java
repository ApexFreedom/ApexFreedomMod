...
public class C_gtfo extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        // Kick player
        player.kickPlayer(ChatColor.RED + "Fuck off and get your shit together you fucked up... If you think that you where wrongly banned please appeal!");
