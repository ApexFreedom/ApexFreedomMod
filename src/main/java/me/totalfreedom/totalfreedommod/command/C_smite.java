...
public class C_smite extends FreedomCommand
{
    ...
    public static void smite(Player player, String reason)
    {
        ...
        if (reason != null)
        {
            FUtil.bcastMsg(ChatColor.YELLOW + "  Reason: " + ChatColor.RED + reason);
        }
        ...
        if (reason != null)
        {
            player.sendMessage(FMsg.F + ChatColor.RED + "You've been smitten for, " + reason);
        }
    }
}
