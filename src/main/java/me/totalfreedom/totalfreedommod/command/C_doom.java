...
@CommandParameters(description = "Used for a proper way to ban the naughty super-admins when they are in-game", usage = "/<command> <playername>")
public class C_doom extends FreedomCommand
{
    ...
    public boolean run(final CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        ban.setReason(ChatColor.RED + "&cFUCKOFF, and get your shit together bitch!");
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.RED + "FUCKOFF, and get your shit together bitch!");
            }
