...
import me.apexfreedom.apexfreedommod.commands.AF_CommandLoader;
import me.apexfreedom.apexfreedommod.donator.DonatorList;
import me.apexfreedom.apexfreedommod.main.HardcoreBanList;
import me.apexfreedom.apexfreedommod.main.SystemAdminChatManager;
import me.apexfreedom.apexfreedommod.worlds.F_WorldManager;
...
import me.totalfreedom.totalfreedommod.command.CmdLoader;
...
public class TotalFreedomMod extends AeroPlugin<TotalFreedomMod>
{
    ...
    public AF_CommandLoader uc;
    public F_WorldManager fwm;
    public HardcoreBanList hbl;
    public SystemAdminChatManager scm;
    ...
    public void enable()
    {
        ...
        backups.createBackups(HardcoreBanList.CONFIG_FILENAME);
        ...
        uc = services.registerService(AF_CommandLoader.class);
        fwm = services.registerService(F_WorldManager.class);
        hbl = services.registerService(HardcoreBanList.class);
        scm = services.registerService(SystemAdminChatManager.class);
        
        rm = services.registerService(RankManager.class);
        cl = services.registerService(CmdLoader.class);
