...
import me.totalfreedom.totalfreedommod.command.C_logs;
...
public class AdminList extends FreedomService
{
    ...
    public void deactivateOldEntries(boolean verbose)
    {
        for (Admin admin : allAdmins.values())
        {
            ...
            if (verbose)
            {
                FUtil.adminAction("CraftedNetwork", "Deactivating Super Admin " + admin.getName() + ", inactive for " + lastLoginHours + " hours", true);
            }
