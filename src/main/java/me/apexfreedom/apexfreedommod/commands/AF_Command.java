...
import me.totalfreedom.totalfreedommod.command.CommandFailException;
...
public abstract class AF_Command extends AbstractCommandBase<TotalFreedomMod>
{
    ...
    public static AF_Command getFrom(Command command)
    {
        try
        {
            return (AF_Command) ((AF_CommandExecutor) (((PluginCommand) command).getExecutor())).getCommandBase();
        }
        catch (Exception ex)
        {
            return null;
